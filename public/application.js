...
var introTemplate = __webpack_require__(23);
var navTemplate = __webpack_require__(40);
var instructionsTemplate = __webpack_require__(41);
var msgTemplate = __webpack_require__(42);
var changePassTemplate = __webpack_require__(43);
var signInTemplate = __webpack_require__(44);
var signUpTemplate = __webpack_require__(45);
var manyGamesTemplate = __webpack_require__(46);
var indexGamesTemplate = __webpack_require__(47);
var newGameTemplate = __webpack_require__(48);
var updateGameTemplate = __webpack_require__(49);
var oneGameTemplate = __webpack_require__(50);
var gameOverTemplate = __webpack_require__(51);
...
var showManyGames = function showManyGames() {
  refresh();
  showNav();
  var manyGamesHtml = manyGamesTemplate();
  $('#content').append(manyGamesHtml);
  showMsg();
};

var storyFill = function storyFill(data) {
  var story = ['<p class="justify">'];
  data.game.sentences.forEach(function (sentence) {
    story.push(sentence);
  });
  story.push('</p>');
  var neatHtml = story.join(' ');
...
var showOneGame = function showOneGame(data) {
  refresh();
  showNav();
  var oneGameHtml = oneGameTemplate();
...
var tableFill = function tableFill(data) {
  var indexGamesHtml = indexGamesTemplate({ 'games': data.games });
...
var showInstructions = function showInstructions() {
  refresh();
  showNav();
  var instructionsHtml = instructionsTemplate();
...
var showUpdateField = function showUpdateField(game, gameValue, id) {
  var gameData = {
    id: id,
    mnemonic: gameValue
  };
  var inputHtml = updateGameTemplate({ 'game': gameData });
  $(game).siblings('.mnemonic').html(inputHtml);
  $(game).siblings('.delete-game').hide();
  $(game).hide();
};

var showNewGameForm = function showNewGameForm() {
  var newGameHtml = newGameTemplate();
  $('#new-game-form-area').html(newGameHtml);
};

var showSignInForm = function showSignInForm() {
  var signHtml = signInTemplate();
  $('#sign-forms').html(signHtml);
};

var showSignUpForm = function showSignUpForm() {
  var signHtml = signUpTemplate();
  $('#sign-forms').html(signHtml);
};
...
var config = {
  apiOrigins: {
    production: 'https://tranquil-brook-35365.herokuapp.com',
...
var store = __webpack_require__(3);
var errorTemplate = __webpack_require__(11);
...
var config = __webpack_require__(7);
var userEvents = __webpack_require__(22);
var gameEvents = __webpack_require__(55);
var gameplayEvents = __webpack_require__(56);
var fillers = __webpack_require__(4);
...
var signInSubmit = function signInSubmit(event) {
  ...
  api.signInUser(data).then(ui.onSignInSuccess).catch(ui.onSignFailure);
};
...
var signUpSubmit = function signUpSubmit(event) {
  ...
  data = JSON.stringify(data);
  api.signUpUser(data).then(ui.onSignUpSuccess).then(api.signInUser).then(ui.onSignInSuccess).catch(ui.onSignFailure);
};

var changePassSubmit = function changePassSubmit(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  data = JSON.stringify(data);
  api.changePassUser(data).then(ui.changePassSuccess).catch(ui.changePassFailure);
};

var signOutClick = function signOutClick() {
  api.signOutUser().then(ui.signOutSuccess).catch(ui.signOutFailure);
};

var addUserEventListeners = function addUserEventListeners() {
...
module.exports = {
  addUserEventListeners: addUserEventListeners
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<!-- INTRO SECTION -->\n<section id=\"intro\">\n  <h1 id=\"game-title\">back<span id=\"titlespan\">OUT</span></h1>\n  <div class=\"center\">\n    <p class=\"justify\">\n      backOut is a story game, inspired by black out poetry and the choose your own adventure genre of games, about emphasis and what redaction means. The protagonist is a young woman who has made a mistake and hopes to correct it, magically; to play, choose from the available terms what she should be focusing on.\n    </p>\n    <button class=\"little-button\" id=\"sign-in-button\">SIGN IN</button>\n    <button class=\"little-button\" id=\"sign-up-button\">SIGN UP</button>\n  </div>\n  <div id=\"sign-forms\" class=\"center\">\n\n  </div>\n</section>\n";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<!-- NAVIGATION SECTION -->\n<nav class=\"navbar navbar-toggleable-md navbar-light bg-faded\" style=\"background: black;\" id=\"navigation\">\n  <button class=\"navbar-toggler navbar-toggler-right\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarSupportedContent\" aria-controls=\"navbarSupportedContent\" aria-expanded=\"false\" aria-label=\"Toggle navigation\">\n    <img src=\"https://image.ibb.co/kvUr57/spell_book.png\" alt=\"Toggle me!\">\n  </button>\n  <a class=\"navbar-brand\" href=\"#\" id=\"greeting-space\"><span class=\"user-greeting\"></span></a>\n  <div class=\"collapse navbar-collapse\" id=\"navbarSupportedContent\">\n    <ul class=\"navbar-nav mr-auto\">\n      <li class=\"nav-item\">\n        <a class=\"nav-link\" href=\"#\" id=\"instructions-link\">INSTRUCTIONS</a>\n      </li>\n      <li class=\"nav-item\">\n        <a class=\"nav-link\" href=\"#\" id=\"game-link\">GAMES</a>\n      </li>\n      <li class=\"nav-item\">\n        <a class=\"nav-link\" href=\"#\" id=\"change-password-link\">CHANGE PASS</a>\n      </li>\n      <li class=\"nav-item\">\n        <a class=\"nav-link\" href=\"#\" id=\"sign-out-link\">SIGN OUT</a>\n      </li>\n\n    </ul>\n  </div>\n</nav>\n";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<!-- INSTRUCTIONS SECTION -->\n      <section id=\"instructions\">\n        <h1>INSTRUCTIONS</h1>\n        <div class=\"justify\">\n          <p><u>backOut</u> is a game about emphasis. To begin, click the <i>games</i> link above, and create a new story. </p>\n          <p>\n          You'll be faced with a sentence, that involves a choice. Two words can be clicked, to shift emphasis. Click one to proceed, and choose again.\n          </p>\n          <p>\n          When you make choices to make the protagonist more hopeful that she can fix her mistake, your hope grows.\n          </p>\n          <p>\n          When you make choices that increase either the protagonist's acceptance of the situation, or her knowledge of it, your wisdom grows.\n          </p>\n          <p>\n          When she gives up, the game is over.\n          </p>\n          <div class=\"quote\">\n            <p>Hope springs eternal in the human breast; </p>\n            <p>Man never Is, but always To be blest. </p>\n            <p>The soul, uneasy, and confin'd from home, </p>\n            <p>Rests and expatiates in a life to come.</p>\n            <p><B>ALEXANDER POPE</B></P>\n          </div>\n        </div>\n      </section>\n";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<!-- CHANGE PASS -->\n<section id=\"change-password\">\n  <h1>CHANGE PASSWORD</h1>\n  <form id=\"change-password-form\">\n    <div class=\"center\">\n      <input name=\"passwords[old]\" type=\"password\" placeholder=\"CURRENT PASSWORD\" class=\"input-field\">\n      <input name=\"passwords[new]\" type=\"password\" placeholder=\"NEW PASSWORD\" class=\"input-field\">\n      <button id=\"changePassButton\" class=\"little-button\">CONFIRM</button>\n    </div>\n  </form>\n</section>\n";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<!-- MANY GAMES -->\n      <section id=\"many-games\">\n        <H1>GAMES</H1>\n          <button id=\"new-game-button\" class=\"little-button\">NEW GAME</button>\n          <div id=\"new-game-form-area\" class=\"center\">\n          </div>\n          <div id=\"display-all-games\" class=\"center\">\n          </div>\n      </section>\n";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n  <tr height=\"50px\">\n    <td class=\"table-cell\" width=\"221px\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n    <p class=\"mnemonic\" data-mnemonic-update=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.mnemonic : stack1), depth0))
    + "\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.mnemonic : stack1), depth0))
    + "</p>\n\n    <span data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"delete-game\">X</span>\n    <span data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"update-game\">EDIT</span>\n\n    </td>\n    <td class=\"table-cell\" width=\"111px\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n    "
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.sentences : stack1)) != null ? stack1.length : stack1), depth0))
    + "\n    </td>\n    <td class=\"table-cell\" width=\"83px\" data-id=\"${game.id}\">\n    "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.hope : stack1), depth0))
    + "\n    </td>\n    <td class=\"table-cell\" width=\"83px\" data-id=\"${game.id}\">\n    "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.wisdom : stack1), depth0))
    + "\n    </td>\n    <td class=\"table-cell\" width=\"111px\">\n    <span data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"play-game\">GO</span>\n    </td>\n  </tr>\n\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "<!-- INDEX GAMES TABLE -->\n<table class=\"center\">\n  <tr>\n    <td class=\"table-top\" width=\"200px\">\n    MNEMONIC\n    </td>\n    <td class=\"table-top\" width=\"50px\">\n    SENTENCES\n    </td>\n    <td class=\"table-top\" width=\"75px\">\n    HOPE\n    </td>\n    <td class=\"table-top\" width=\"75px\">\n    WISDOM\n    </td>\n    <td class=\"table-top\" width=\"100px\">\n    PLAY\n    </td>\n  </tr>\n\n"
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<!-- UPDATE GAME -->\n<form class=\"update-game-form\" data-id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.game : depth0)) != null ? stack1.id : stack1), depth0))
    + "\">\n    <input type=\"text\" name=\"game[mnemonic]\" style=\"max-width: 200px\" value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.game : depth0)) != null ? stack1.mnemonic : stack1), depth0))
    + "\">\n</form>\n  <span data-id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.game : depth0)) != null ? stack1.id : stack1), depth0))
    + "\" class=\"cnfrm\">CNFRM</span>\n  <span data-id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.game : depth0)) != null ? stack1.id : stack1), depth0))
    + "\" class=\"nvm\">NVM</span>\n";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<!-- ONE GAME -->\n      <section id=\"one-game\">\n        <H1 id=\"mnemonic-title\"></H1>\n          <div id=\"stats\" class=\"center\">\n            <div id=\"hope-bar\">\n              <div id=\"hope-bar-percentage\">\n              </div>\n            </div>\n            <div id=\"hope-text\" >HOPE</div>\n            <div id=\"wisdom-bar\">\n              <div id=\"wisdom-bar-percentage\">\n              </div>\n            </div>\n            <div id=\"wisdom-text\" >WISDOM</div>\n        </div>\n          <div id=\"display-one-game\">\n          </div>\n        </section>\n";
},"useData":true});
...
var store = __webpack_require__(3);
var errorTemplate = __webpack_require__(11);
var successTemplate = __webpack_require__(54);
...
var onSignFailure = function onSignFailure(data) {
  var errorHtml = errorTemplate();
  $('#sign-forms').html(errorHtml);
};

var changePassSuccess = function changePassSuccess() {
  var successHtml = successTemplate();
...
var onPlayClick = function onPlayClick(event) {
  var id = $(event.target).data('id');
  api.showGame(id).then(ui.showGameSuccess).catch(ui.showGameFailure);
};

// Takes the updated mnemonic and places it a copy of original game.
var smooshUpdate = function smooshUpdate(returnedData, formData) {
  returnedData.game.mnemonic = formData.game.mnemonic;
  return api.updateGame(returnedData);
};

var onEditSubmit = function onEditSubmit(event) {
  event.preventDefault();
  var id = $(event.target).data('id');
  var data = getFormFields(event.target);
  api.showGame(id).then(function (returnedData) {
    return smooshUpdate(returnedData, data);
  }).then(api.indexGames).then(ui.indexGamesSuccess).catch(ui.indexGamesFailure);
};

var onCnfrmClick = function onCnfrmClick(event) {
  $(event.target).parent('.mnemonic').children('.update-game-form').submit();
};

var onNvmClick = function onNvmClick() {
  api.indexGames().then(ui.indexGamesSuccess).catch(ui.indexGamesFailure);
};

var updateGameClick = function updateGameClick(event) {
  var id = $(event.target).data('id');
  var gameValue = $(event.target).siblings('.mnemonic').data('mnemonic-update');
  fillers.showUpdateField(event.target, gameValue, id);
};

var deleteGameClick = function deleteGameClick(event) {
  var id = $(event.target).data('id');
  api.deleteGame(id).then(api.indexGames).then(ui.indexGamesSuccess).catch(ui.indexGamesFailure);
};

var newGameSubmit = function newGameSubmit(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  data.game.hope = 75;
  data.game.wisdom = 50;
  ...
  data = JSON.stringify(data);
  api.createGame(data).then(ui.createGameSuccess).then(api.indexGames).then(ui.indexGamesSuccess).catch(ui.createGameFailure);
};

var gameButtonClick = function gameButtonClick() {
  fillers.showNewGameForm();
};

var gameLinkClick = function gameLinkClick() {
  fillers.showManyGames();
  api.indexGames().then(ui.indexGamesSuccess).catch(ui.indexGamesFailure);
};

var addGamesEventListeners = function addGamesEventListeners() {
...
module.exports = {
  addGamesEventListeners: addGamesEventListeners
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
var getNextSteps = __webpack_require__(57);
var store = __webpack_require__(3);
var striptags = __webpack_require__(58);
var api = __webpack_require__(12);
var ui = __webpack_require__(13);

var redactSentence = function redactSentence(sentence, redactionArray) {
  ...
  if (redactionArray.length > 0) {
    ...
    redactionArray.forEach(function (redact) {
      sentenceArray.forEach(function (word) {
        // ... check to see if the index of the word matches that index.
        var wordNumber = sentenceArray.indexOf(word);
...
var stripPreviousSentence = function stripPreviousSentence() {
  // Takes the stored value of the game's sentences.
  var sentenceArray = store.currentGame.sentences.slice();
  // Strips html tags from the last one.
  var updatedSentence = striptags(sentenceArray[sentenceArray.length - 1]);
...
var storyProgress = function storyProgress(event) {
  // Takes the id of the clickable span.
  var stepId = $(event.target).data('id');
  ...
  var step = getNextSteps(stepId);
  var sentenceArray = stripPreviousSentence();
  // Expect sentenceArray to be a copy of the game's sentences, with htm tags removed.
  var redactedSentence = redactSentence(sentenceArray[sentenceArray.length - 1], step.redaction);
  ...
  api.updateGame(data).then(ui.showGameSuccess).catch(ui.showGameFailure);
};

var addGameplayEventListeners = function addGameplayEventListeners() {
  $('#content').on('click', '.clickable', storyProgress);
};

module.exports = {
  addGameplayEventListeners: addGameplayEventListeners
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
var getNextSteps = function getNextSteps(stepNumber) {
  var nextStep = {};
